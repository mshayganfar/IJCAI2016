...
\AtBeginShipout{\AtBeginShipoutUpperLeft{%
  \put(\dimexpr\paperwidth-11.2cm\relax,-1cm){\makebox[0pt][r]{\framebox{UNDER
  REVIEW. PLEASE DO NOT REDISTRIBUTE.}}}%
}}
...
very small \textit{p}-values indicate that the data set is not random; in fact,
the high percentage of similarity confirms our hypothesis and shows that the
