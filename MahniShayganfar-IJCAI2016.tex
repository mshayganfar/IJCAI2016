...
(since it categorically separates certain emotions and can be used as an
intensity variable), \textit{Expectedness} (since it captures causality based on
the past knowledge of the tasks), and \textit{Controllability} (since it is
associated with the agent's coping ability). There are other appraisal variables
...
algorithms in this section use mental states of the robot (see Section
